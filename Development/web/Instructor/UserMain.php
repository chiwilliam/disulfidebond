...
<div id="container">
    ...
    <div id="main">
        ...
        <div id="content">
			<div id="banner1">
				<h2>Instructor Main Page</h2>
				This page lists all data for groups under the same configuration.
                The data is listed by group members and it is divided by categories.
			</div>
            <div id="filters">
                <!-- table with filters -->
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_row_border">
                      ...
                      <tr>
                        <td colspan="3" align="center"><font size="3" color="blue">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a target="_blank" href="../Instructor/CommentsController.php"><b>ADD COMMENTS</b></a>
                        </font></td>
                      </tr>
                      <tr>
                        <td class="cfl"></td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="info_row_border">
                  ...
                  <tr>
                    <td align="center" colspan="3">
                        <a href="../Instructor/UserMainController.php?type=<?php echo $type; ?>&selected=<?php echo $selected; ?>&chart=piechart">PIECHART</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="../Instructor/UserMainController.php?type=<?php echo $type; ?>&selected=<?php echo $selected; ?>&chart=barchart">BARCHART</a>
                    </td>
                  </tr>
				</table>
		  	  </div>
