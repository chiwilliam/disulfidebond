...
<title>Productivity Tracker - Student Project Information</title>
...
<div id="container">
    ...
    <div id="main">
        ...
        <div id="content">
            <div id="filters">
                <!-- table with filters -->
                <form name="filtersform" method="post" action="./ProjectController.php">
            ...
            <table style="visibility:<?php echo $visible; ?>" align="center" border="5px" id="projectinfo" width="400">
                <tr>
                    ...
                    <td width="200"><input size="30" type="text" name="projectname" value="<?php echo $project->getProjectname();?>"/></td>
                </tr>
                <tr>
                    <td width="150"><LABEL>Project URL:</LABEL></td>
                    <td width="200"><input size="30" type="text" name="projecturl" value="<?php echo $project->getProjecturl();?>"/></td>
                </tr>
                <tr>
                    <td width="150"><LABEL>Sub Projects:</LABEL></td>
                    <td width="200"><input size="30" type="text" name="subprojects" value="<?php echo count($subprojects);?>"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="200"><textarea name="description" rows="5" cols="28" style="font-size:small"><?php echo $project->getDescription();?></textarea></td>
                </tr>
                </table>
            </form>
        </div>
