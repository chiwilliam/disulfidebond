...
var MENU_ITEMS = [
    ...
    {code:"User",url:"../User/UserMainController.php",
        sub:[
            {},
            {code:"Main Page",url:"../User/UserMainController.php"},
            {code:"Edit Profile", url:"../User/StudentProfileController.php?mode=student"}
        ]
    },
    {code:"Project",url:"../User/ProjectController.php",
        sub:[
            {},
            {code:"View Comments", url:"../User/CommentsController.php"},
            {code:"Project Information", url:"../User/ProjectController.php"}
        ]
    },
    {code:"Group",url:"../User/GroupController.php",
        sub:[
            {},
            {code:"View Comments", url:"../User/CommentsController.php"},
            {code:"Group Information", url:"../User/GroupController.php"}
        ]
    },
