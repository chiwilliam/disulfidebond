...
<div id="navigation" class="horizontalmenu">
    <ul>
        ...
        <li <?php if($page == "citing") echo 'class="selected"'; else echo 'class="notselected"'; ?>><a <?php if($page == "citing") echo 'class="selected"'; else echo 'class="notselected"'; ?> href="citing.php" onmouseover="Tip('Citing MS2DB')" onmouseout="UnTip()">Citing Us</a></li>
        ...
        <li <?php if($page == "comparison") echo 'class="selected"'; else echo 'class="notselected"'; ?>><a <?php if($page == "comparison") echo 'class="selected"'; else echo 'class="notselected"'; ?> href="comparison.php" onmouseover="Tip('Comparison with other disulfide bond determination methods')" onmouseout="UnTip()">Comparison with other methods</a></li>
